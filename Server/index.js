...
const API_KEY = "94f3fade6abc7fcb7992f159a7c877a5";
const AUTH_KEY = "500125de33455e904bc76e78f596cd15";
...
app.get("/account/:id",(req,res)=>{
    const id=req.params.id;
    let sqll=`select * from orders where userid=${id} `;
    db.query(sqll,(err,result)=>{
        if(err)
        {
            console.log(err)
                        ...
                        //  open.open(redirectUrl)
                         res.send({
                            ...
                            "payment_request": {
                              ...
                              "sms_status": "Sent",
                              "email_status": "Sent",
                              "shorturl": "https://www.instamojo.com/shorturl",
                              "longurl": REDIRECT_URL,
                              "redirect_url":REDIRECT_URL,
                              "webhook": "https://yourwebsite.com/webhook",
                              "created_at": "2024-11-02T10:10:00.000Z",
                              "modified_at": "2024-11-02T10:12:00.000Z"
                            },
                            "payment": {
                              "payment_id": "MOJO1234P567890",
                              "status": "Credit",
                              "payment_type": "Credit Card",
                              "amount": "1000.00",
                              "fees": "20.00",
                              "total_amount": "1020.00",
                              "created_at": "2024-11-02T10:11:00.000Z"
                            }
                          }
                          )
